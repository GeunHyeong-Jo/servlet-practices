...
import com.saltlux.mysite.dao.GuestbookDaoFirst;
import com.saltlux.mysite.dao.GuestbookDaoSecond;
...
public class GuestbookServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if ("deleteform".equals(action)) {
			...
			new GuestbookDaoFirst().insert(vo);
			...
			vo.setPassword(password);
			new GuestbookDaoFirst().delete(vo);
			...
			list = (new GuestbookDaoSecond().findAll());
