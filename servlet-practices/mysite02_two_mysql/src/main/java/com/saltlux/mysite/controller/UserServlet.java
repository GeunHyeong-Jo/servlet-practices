...
import com.saltlux.mysite.dao.UserDaoFirst;
import com.saltlux.mysite.dao.UserDaoSecond;
...
public class UserServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if ("joinform".equals(action)) {
			...
			String email = new UserDaoSecond().getEmailFindByNo(no);
			...
			new UserDaoFirst().update(userVo);
			...
			UserVo authUser = new UserDaoSecond().findByEmailAndPassword(vo);
			if (authUser == null) {
			...
			new UserDaoFirst().insert(userVo);
